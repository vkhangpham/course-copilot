...
def build_plan_course_program(*, max_iters: int = DEFAULT_PLAN_ITERS) -> dspy.Module:
...
def build_draft_lecture_program(*, max_iters: int = DEFAULT_LECTURE_ITERS) -> dspy.Module:
