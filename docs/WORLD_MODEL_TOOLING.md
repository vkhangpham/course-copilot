...
3. **Ingest** – the ingestion CLI rewrites `world_model/state.sqlite` and emits a JSONL snapshot
...
- **Need a quick sample** – `wm-inspect timeline --store world_model/state.sqlite --year 2012`
